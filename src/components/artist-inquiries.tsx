...
export function ArtistInquiries() {
  return (
    <section
      id="artist-inquiries"
      className="relative bg-charcoal px-6 py-28 md:py-40"
    >
      <div className="absolute inset-0 bg-texture-ink-wash opacity-25" />
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        <div className="reveal mb-20 text-center">
          ...
          <p className="eyebrow mb-6 justify-center text-sand/60">
            Contact
          </p>
